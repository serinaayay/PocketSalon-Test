...
const myData = [
      ...
      { id: 'breakage', title: 'Aggressive Brushing', description: 'Aggressive brushing while your hair is wet is a key cause of hair breakage, especially if you brush while hair is still tangled. Instead, use a wide-tooth\ncomb to detangle, and comb later on. ' },
      { id: 'breakage', title: 'Over processing', description: 'Frequent chemical treatments, such as coloring, perming, and relaxing can weaken hair structure, leading to increased breakage especially if it is done too often, as the hair cuticle can break down and cause hair damage.' },
      { id: 'breakage', title: 'Diet', description: 'Eating appropriately and ensuring that your food contains enough nutrients is essential to having healthy hair, as the hair follicles might not have enough nutrients to produce new hairs, or hairs may break in the middle of the growing process.'},
      { id: 'breakage', title: 'Tight Hairstyles', description: 'Using hair ties that are too tight or hairstyles that pull on the hair can cause tension and lead to breakage over time. You can opt for looser hair styles or wearing your hair down once\nin a while.' },
      { id: 'breakage', title: 'Improper Towel Drying', description: 'Although it is normal to dry our hair using a towel, having a proper rubbing motion prevents hair damage, especially that the hair is vulnerable when wet. It is also recommended to use an absorbent towel around the hair to absorb excess water.' },
      { id: 'breakage', title: 'Low Thyroid', description: 'Low thyroid significantly affects hair health. People with low thyroid might have excessive hair damage and hair loss after shower or brushing.' },
      { id: 'breakage', title: 'Lack of Hair Trims', description: 'Hair trims not only provide us a new look but can also keep our hair healthy! Hair trims free our hair from split ends that can travel to the rest of the length of the hair, resulting to possible breakage.' },
      { id: 'breakage', title: 'Dryness', description: 'Having dry hair that feels rough and brittle is often caused by a lack of moisture or natural oils. This can make hair more prone to tangling, frizz, and breakage. Consider concentrating shampoo on your scalp and consistent use of conditioner.' },
      
      { id: 'color damage', title: 'Chemical Treatments', description: 'Frequent chemical treatments, such as coloring, perming, and relaxing can weaken hair structure, leading to increased damage especially if it is done too often, as the hair cuticle can break down and cause hair damage.' },
      { id: 'color damage', title: 'Too Much Sun Exposure', description: 'Prolonged exposure to the sun\'s UV rays can lead to fading hair color damage. UV rays can break down the hair cuticle, which may lead to color loss and brittle hair. Wearing hats or using hair products with UV protection can help minimize this damage.' },
      ...
      { id: 'color damage', title: 'Exposure to Chlorine', description: 'Swimming in pools can cause color-treated hair to become dry and damaged. Chlorine can damage the hair\'s natural oils, while saltwater can lead to dryness and brittleness.' },
      { id: 'color damage', title: 'Overwashing', description: 'Washing color-treated hair too frequently can lead to color fading and dryness. The hair cuticle is vulnerable to damage when wet, making the hair strands more fragile. It is also important to use conditioner regularly to limit water absorption into the cuticle.' },
      { id: 'color damage', title: 'Hot Water', description: 'Using hot water can open the hair cuticle, allowing the hair dye to be washed out. Instead, you can use cold water to prevent your hair color from fading.' },
      { id: 'color damage', title: 'Proper Diet', description: 'A poor diet not only results in hair breakage but can also be the cause of why the color fades faster than usual. \nIt is recommended to maintain a healthy and balanced diet to promote hair health.' },
      { id: 'color damage', title: 'Lack of Moisture', description: 'Color-treated hair tends to be drier than natural hair, making it more prone to damage. Using moisturizing hair products and deep conditioning treatments can help maintain the hair\'s moisture balance and prevent damage.' },
