...
const myData = [
      ...
      { id: 'breakage', title: 'Aggressive Brushing', description: 'Aggressive brushing while your hair is wet is a key cause of hair breakage, especially if you brush while hair is still tangled. Instead, use a wide-tooth comb to detangle, and comb later on. ', Image: require('../assets/images/aggressive brushing.jpg') },
      ...
      { id: 'hair loss', title: 'Nutritional Deficiencies', description: 'Lack of essential nutrients, such as iron, biotin, vitamins A, C, D, and E, can contribute to hair loss. A balanced diet is crucial for maintaining healthy hair growth.', Image: require('../assets/images/vitamins.jpg') },
      { id: 'hair loss', title: 'Genetics', description: 'Genetic factors play a significant role in hair loss patterns. If there is a family history of hair loss, some members of the family may be more prone to experiencing it themselves.', Image: require('../assets/images/genetics.jpg') },
      { id: 'hair loss', title: 'Hormonal Changes', description: 'Hormonal fluctuations, such as those occurring during pregnancy, menopause, or thyroid imbalances, can contribute to temporary or permanent hair loss.', Image: require('../assets/images/hormonal.jpg') },
      { id: 'hair loss', title: 'Medical Conditions', description: 'Certain medical conditions, such as alopecia, scalp infections, and autoimmune diseases, can lead to hair loss. Treating the underlying condition is essential for managing hair loss in these cases.', Image: require('../assets/images/alopecia.jpg') },
      { id: 'hair loss', title: 'Stress', description: 'Physical or emotional stress can trigger hair loss, often resulting in a condition called telogen effluvium. Managing stress through relaxation techniques and proper self-care can help lessen this type of hair loss.', Image: require('../assets/images/stress.jpg') },
      { id: 'hair loss', title: 'Tight Hairstyles', description: 'Tight hairstyles can cause a specific type of hair loss called traction alopecia. You can opt for looser hairstyles or wearing your hair down once in a while.', Image: require('../assets/images/tight hairstyles.jpg') },
      { id: 'hair loss', title: 'Medications and Supplements', description: 'Certain medications used for cancer, heart problems, and high blood pressure, can have side effects that include hair loss.', Image: require('../assets/images/medicines.jpeg') },
      { id: 'hair loss', title: 'Aging', description: 'As people grow older, hair follicles stop growing hair and hair starts to lose color, as the follicles stop producing melanin. ', Image: require('../assets/images/aging.jpg') },
      { id: 'hair loss', title: 'Poor Scalp Health', description: 'Conditions such as dandruff, psoriasis, and fungal infections can negatively impact scalp health, leading to hair loss. Maintaining a clean and healthy scalp is essential for promoting hair growth.', Image: require('../assets/images/poor scalp health.jpg') },
      { id: 'hair loss', title: 'Chemical Treatments', description: 'Frequent chemical treatments, such as coloring, perming, and relaxing can weaken hair structure, leading to hair loss.', Image: require('../assets/images/hair coloring.jpg') },
      { id: 'hair loss', title: 'Hair Pulling', description: 'Hair pulling, also known as trichotillomania, is a mental health condition where people pull hair from the scalp to alleviate stress. A doctor or mental health professional is recommended for diagnosis and appropriate treatment options. ', Image: require('../assets/images/hair pulling.jpg') },
